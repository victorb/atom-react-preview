...
/***/ function(module, exports, __webpack_require__) {
	...
	var _renderer = __webpack_require__(160);
	...
	var updateComponents = function updateComponents(new_props) {
	  var combined_props = Object.assign({}, component_props, new_props);
	  render(combined_props);
	};

	var render = function render(props) {
	  var subcomponent_to_render = _react2.default.createElement(_test2.default, props);

	  var component_to_render = _react2.default.createElement(_renderer2.default, {
	    dispatch: updateComponents,
	    component_props: props
	  }, subcomponent_to_render);

	  _reactDom2.default.render(component_to_render, document.body);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Name = (function (_Component) {
	  ...
	  _createClass(Name, [{
	    ...
	    value: function render() {
	      ...
	      var pet_singular = this.props.pets.length === 1;
	      var pet_or_pets = 'pets';
	      if (pet_singular) {
	        pet_or_pets = 'pet';
	      }
	...
	Name.propTypes = {
	  ...
	  pets: _react.PropTypes.array,
	  age: _react.PropTypes.number,
	  is_tired: _react.PropTypes.bool,
	  show_warning: _react.PropTypes.bool
	};
	Name.defaultProps = {
	  name: 'Victor',
	  number: 5,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _find_component_proptypes = __webpack_require__(161);

	var _find_component_proptypes2 = _interopRequireDefault(_find_component_proptypes);
	...
	var StringProps = (function (_Component) {
	  _inherits(StringProps, _Component);

	  function StringProps() {
	    _classCallCheck(this, StringProps);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(StringProps).apply(this, arguments));
	  }

	  _createClass(StringProps, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;

	      var required_render = this.props.isRequired ? '*' : '';
	      return _react2.default.createElement(
	        'div',
	        null,
	        this.props.label,
	        ...
	        _react2.default.createElement('input', {
	          ...
	          onChange: function onChange(ev) {
	            _this2.props.onChange(_this2.props.label, ev.target.value);
	          },
	          onKeyUp: function onKeyUp(ev) {
	            if (ev.keyCode === 13) {
	              _this2.props.onChange(_this2.props.label, ev.target.value, true);
	            }
	          }
	        })
	      );
	...
	var ArrayProps = (function (_Component2) {
	  _inherits(ArrayProps, _Component2);

	  function ArrayProps() {
	    _classCallCheck(this, ArrayProps);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ArrayProps).apply(this, arguments));
	  }

	  _createClass(ArrayProps, [{
	    key: 'render',
	    value: function render() {
	      var _this4 = this;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', {
	          ...
	          onChange: function onChange(ev) {
	            _this4.props.onChange(_this4.props.label, JSON.parse(ev.target.value));
	          },
	          onKeyUp: function onKeyUp(ev) {
	            if (ev.keyCode === 13) {
	              _this4.props.onChange(_this4.props.label, JSON.parse(ev.target.value), true);
	            }
	          }
	        })
	      );
	...
	var NumberProps = (function (_Component3) {
	  _inherits(NumberProps, _Component3);

	  function NumberProps() {
	    _classCallCheck(this, NumberProps);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(NumberProps).apply(this, arguments));
	  }

	  _createClass(NumberProps, [{
	    key: 'render',
	    value: function render() {
	      var _this6 = this;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', {
	          ...
	          defaultValue: this.props.defaultValue,
	          onChange: function onChange(ev) {
	            _this6.props.onChange(_this6.props.label, ev.target.value);
	          },
	          onKeyUp: function onKeyUp(ev) {
	            if (ev.keyCode === 13) {
	              _this6.props.onChange(_this6.props.label, ev.target.value, true);
	            }
	          }
	        })
	      );
	...
	var BoolProps = (function (_Component4) {
	  _inherits(BoolProps, _Component4);

	  function BoolProps() {
	    _classCallCheck(this, BoolProps);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(BoolProps).apply(this, arguments));
	  }

	  _createClass(BoolProps, [{
	    key: 'render',
	    value: function render() {
	      var _this8 = this;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', {
	          ...
	          onClick: function onClick(ev) {
	            _this8.props.onChange(_this8.props.label, ev.target.checked, true);
	          }
	        })
	      );
	    }
	...
	var PropsEditor = (function (_Component5) {
	  _inherits(PropsEditor, _Component5);

	  function PropsEditor() {
	    _classCallCheck(this, PropsEditor);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(PropsEditor).apply(this, arguments));
	  }
	  ...
	  _createClass(PropsEditor, [{
	    ...
	    value: function render() {
	      ...
	      var props_to_edit = Object.keys(this.props.props).map(function (key) {
	        var defVal = _this10.props.props[key].defaultValue;
	        var required = _this10.props.props[key].required;
	        var type = _this10.props.props[key].type;
	        var type_props = props_map[type];
	        return _react2.default.createElement(type_props, {
	          label: key,
	          isRequired: required,
	          defaultValue: defVal,
	...
	var Renderer = (function (_Component6) {
	  _inherits(Renderer, _Component6);

	  function Renderer(props) {
	    _classCallCheck(this, Renderer);

	    var _this11 = _possibleConstructorReturn(this, Object.getPrototypeOf(Renderer).call(this, props));

	    _this11.state = _this11.props.component_props;
	    return _this11;
	  }

	  _createClass(Renderer, [{
	    key: 'handleOnChange',
	    value: function handleOnChange(label, value, should_trigger_update) {
	      var _this12 = this;

	      this.setState(_defineProperty({}, label, value), function () {
	        if (should_trigger_update) {
	          _this12.props.dispatch(_this12.state);
	        }
	      });
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      var children_props = (0, _find_component_proptypes2.default)(this.props.children.type, this.props.component_props);
	      var render_style = {
	        position: 'absolute',
	        top: 0,
	        right: 0,
	      ...
	      var ren_comp_title_style = Object.assign({}, title_style, { position: 'relative' });
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              { onClick: function onClick() {
	                  _this13.props.dispatch(_this13.state);
	                } },
	              'Update Component Props'
	            ),
	            _react2.default.createElement(PropsEditor, { props: children_props, onChange: this.handleOnChange.bind(this) })
	          )
	        )
	      );
	    }
	...
	Renderer.propTypes = {
	  ...
	  component_props: _react.PropTypes.object
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (component, default_values) {
	  var mapping = {};
